import { compose, mapProps, setDisplayName, setPropTypes, withHandlers, withProps, withPropsOnChange, withState } from 'recompose';
import uniqueId from 'lodash.uniqueid';
import React, { Children, Component, Fragment, cloneElement, isValidElement } from 'react';
...
var iconHandler = ( /* istanbul ignore next */function (Component$$1) {
  return (
    /* istanbul ignore next */compose(setDisplayName(Component$$1.displayName || Component$$1.name || 'Icon'), mapProps(addLunaClass))(Component$$1)
  );
});
...
var AccordionWrapper = compose(setDisplayName('Accordion'), withState('open', 'setOpenState', function (_ref3) {
  var defaultOpen = _ref3.defaultOpen;
  return !!defaultOpen;
}), withHandlers({ handleClick: handleClick }), withPropsOnChange(function () {
  return false;
}, createIds))(Accordion);
...
var BreadcrumbsItem = function BreadcrumbsItem(_ref) {
  ...
  return React.createElement(
    ...
    active ? children : React.createElement(
      'span',
...
var Button = function Button(_ref) {
  ...
  return React.isValidElement(containerElement) ? React.cloneElement(containerElement, props, children) : React.createElement(containerElement, props, children);
};
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.cloneElement(Element, {
        ...
        null,
        label,
        React.createElement('span', { className: 'ln-c-navigation__dropdown-icon' })
      ))
    ),
    React.createElement(
      'div',
      { className: classnames('ln-c-navigation__dropdown', isOpen && 'is-open') },
      React.createElement(Navigation$1, { items: items })
    )
  );
};
...
var MenuButton = function MenuButton(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('span', { className: 'ln-c-navigation-toggle__item' })
    )
  );
};
...
var NavigationDropdown$2 = compose(setDisplayName(NavigationDropdown.displayName), withState('isOpen', 'setOpen', false), withHandlers({
...
var TopBar = function TopBar(_ref) {
  ...
  var addOnClickHandler = function addOnClickHandler(menuItem) {
    return cloneElement(menuItem, { onClick: createOnClickHandle(menuItem.props.onClick) });
  };
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Navigation.List, {
            ...
            items: logo ? [React.createElement(
              'li',
...
var FormGroup = function FormGroup(_ref) {
  ...
  return React.createElement(
    ...
    (hasError || hasWarning) && React.createElement(
      FieldInfo,
      {
        id: name + 'Validation',
...
var TextInput = function TextInput(_ref) {
  ...
  return React.createElement(Input, _extends({ className: classnames('ln-c-text-input', className) }, props));
};
...
var InputControl = function InputControl(_ref) {
  ...
  return React.cloneElement(element, { className: classnames('ln-c-input-group__control', element.props && element.props.className) });
};
...
var InputAction = function InputAction(_ref) {
  ...
  return React.cloneElement(element, { className: classnames('ln-c-input-group__action', element.props && element.props.className) });
};
...
var TextInputField = function TextInputField(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      action && actionFirst && React.createElement(
        InputAction,
        null,
        action
      ),
...
var Password$1 = function Password(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      InputControl,
      null,
      React.createElement(TextInput, _extends({}, props, { type: showText ? 'text' : 'password' }))
    ),
    hasToggle && setTextVisibility && React.createElement(
      InputAction,
      null,
      React.createElement(
        Button,
...
var Password = compose(setDisplayName('Password'), withState('showText', 'setTextVisibility', false))(Password$1);
...
var PasswordField = function (_Component) {
  ...
  PasswordField.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(Password, _extends({
        required: requiredFlag,
        invalid: error !== undefined ? !!error : undefined,
      ...
      strengthIndicator && React.createElement(
        'div',
...
var FormOptionField = function FormOptionField(_ref3) {
  ...
  return React.createElement(
    ...
    options.length > 1 ? React.createElement(
      List,
      { type: 'bare' },
      options.map(function (option) {
        return React.createElement(
...
var CheckboxField = compose(setDisplayName('CheckboxField'), withProps({ optionType: 'checkbox' }))(FormOptionField);

var RadioButtonField = compose(setDisplayName('RadioButtonField'), withProps({ optionType: 'radio' }))(FormOptionField);
...
var TextAreaField = function (_Component) {
  ...
  TextAreaField.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      characterCount && props.maxLength && React.createElement(
        'p',
...
var SearchField = function SearchField(_ref) {
  ...
  return React.createElement(
    ...
    props.hasButton ? React.createElement(
      Flag.Wrapper,
      null,
      React.createElement(
        Flag.Body,
        null,
        React.createElement(SearchInput, filterProps(inputProps, excludeProps))
      ),
      React.createElement(
        Flag.Component,
        null,
...
var getClearActionProps = function getClearActionProps(value, clearValue) {
  return value.length > 0 ? { hasAction: true, action: React.createElement(CancelButton, { onClick: clearValue, 'aria-label': 'Clear the field' }) } : { hasAction: false, action: undefined };
};
...
var Search$2 = compose(setDisplayName('Search'), withState('value', 'changeValue', ''), withState('open', 'onExpandClick', false), withHandlers({
  toggle: toggle$1,
...
var IconNavigation = function IconNavigation(_ref) {
  ...
  return React.createElement(Navigation.List, _extends({}, rest, {
    className: navigationClasses$1,
    items: onSearchSubmit ? [React.createElement(
      'li',
...
var MainBar = function MainBar(_ref) {
  ...
  return React.createElement(
    ...
    _extends({}, rest, {
      title: logo,
      button: iconNav.length > 0 || menuItems.length > 0 || Object.keys(topBar).length > 0 ? React.createElement(MenuButton, { className: 'ln-c-header__toggle', onClick: toggle }) : undefined,
      container: container,
      className: className
    }),
    ...
    }), showNavList > 0 && React.createElement(Navigation.List, { key: 'mainNav', items: menuItems.map(addOnClickHandler) })]
  );
};
...
var Header = compose(setPropTypes(_extends({}, Header$1.propTypes, {
  open: PropTypes.bool,
  toggle: PropTypes.func
...
var Checkbox = compose(setDisplayName('Checkbox'), withProps({ type: 'checkbox' }))(FormOption);

var RadioButton = compose(setDisplayName('RadioButton'), withProps({ type: 'radio' }))(FormOption);
...
var NotificationItem = function NotificationItem(_ref) {
  ...
  return React.createElement(
    ...
    notification && handleClose && React.createElement(CloseButton, { onClick: handleClose }),
    children
  );
};
...
var PageBody = function PageBody(_ref) {
  ...
  return React.cloneElement(element, { className: classnames('ln-o-page__body', element.props && element.props.className) });
};
...
var PageHeader = function PageHeader(_ref) {
  ...
  return React.cloneElement(element, { className: classnames('ln-o-page__header', element.props && element.props.className) });
};
...
var PageFooter = function PageFooter(_ref) {
  ...
  return React.cloneElement(element, { className: classnames('ln-o-page__footer', element.props && element.props.className) });
};
...
var SiteLayout = function SiteLayout(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      PageBody,
      null,
      headerBody || React.createElement(
        HeaderBody,
        null,
...
var StatusCard = function StatusCard(_ref) {
  ...
  var body = React.createElement(
    ...
    (link || onClick) && React.createElement(
      'div',
  ...
  return React.isValidElement(containerElement) ? React.cloneElement(containerElement, props, body) : React.createElement(onClick ? 'button' : containerElement, props, body);
};
...
var TableWrapper = compose(setDisplayName('Table'), withState('sorted', 'setSorted', {}), withHandlers({
  sortData: sortData
...
var hasInnerRef = function hasInnerRef(element) {
  return isValidElement(element) && !!element.type.propTypes && !!element.type.propTypes.innerRef;
};
...
export { AccordionWrapper as Accordion, Breadcrumbs, Button, PrimaryButton, SecondaryButton, TextButton, OutlinedButton, CancelButton, CloseButton, SearchButton, ButtonGroup, Card, ColleagueLayout, HeaderBody as MainSection, Container, Flag, Footer, Form, FormGroup, TextInputField, PasswordField, SelectField, CheckboxField, RadioButtonField, TextAreaField, SearchField, Fieldset, Legend, withClear, Grid, Header, HeaderBody, InputAction, InputControl, InputGroup, InputIcon, Checkbox, Password, RadioButton, Select, TextArea, TextInput, SearchInput, List, ListItem, LoadingIndicator, LoadingIcon, Modal, Navigation, MenuButton, NavigationDropdown$2 as NavigationDropdown, Notification, Page, PageBody, PageHeader, PageFooter, Search$2 as Search, Section, SiteLayout, SiteWrap, StatusCard, TableWrapper as Table, Tabs, TabList, TabLink, TabPanel };
